# R Package BLASTpileR
#
# Functions to process data from BLAST search of Y1000 genome data
#
# ----------------------------------------------------------
#
#                   seqPile function
...
#
# BLAST hits might include fragmented matches to a subject DNA. This function
#   identifies the highest scoring match per subject DNA and any nearby matches
#   that may be fragments of the overall match.
#
# INPUT
